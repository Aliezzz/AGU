...
class GINNet(torch.nn.Module):
    def __init__(self, in_channels, h_dim, bias, out_channels, dropout, num_layers=2):
        ...
        self.convs.append(GINConv(Linear(in_channels, dim, bias=bias)))
        self.convs.append(GINConv(Linear(dim, out_channels, bias=bias)))
